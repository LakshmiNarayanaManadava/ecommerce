...
const pages = ['Signup', 'Signin', 'Electronics', 'Vegatables', 'Groceries', 'Home', "Admin"];
const settings = ['Logout'];

function ResponsiveAppBar({store, x, y}) {
            ...
            >
              {settings.map((setting) => (
                <MenuItem key={setting} >
                  <Typography onClick={handleCloseUserMenu} sx={{ textAlign: 'center' }}>{setting}</Typography>
                </MenuItem>
              ))}
            </Menu>
          </Box>
